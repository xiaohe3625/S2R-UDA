    ...
    def get_class_weights(dataset_name):
        ...
        if dataset_name is 'S3DIS':
            ...
            num_per_class = np.array([5181602, 5012952, 6830086, 1311528, 10476365, 946982, 334860, 269353],
                                     dtype=np.int32)
        elif dataset_name is 'carla':
            num_per_class = np.array([75678538,34799886,811060,11032874,3299439],dtype=np.int32)     

        elif dataset_name is 'npm3d':
            num_per_class = np.array([65075320,33014819, 656096, 61715, 296523, 4052947, 172132, 4212295, 10599237],
                                       dtype=np.int32)#lille1_1  lille2  paris  lille1_2 
